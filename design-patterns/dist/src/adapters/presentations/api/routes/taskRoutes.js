...
const updateTaskControllerFactory_1 = require("../../../factories/updateTaskControllerFactory");
exports.default = (router) => {
    ...
    router.patch("/tasks", (0, expressRouteAdapter_1.expressRouteAdapter)((0, updateTaskControllerFactory_1.updateTaskControllerFactory)()));
};
